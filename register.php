...
<body>
    ...
    <div class="h-screen flex items-center justify-center">
        <div class="px-4 max-w-screen-xl flex items-center justify-center md:flex-row rounded-xl gap-2">
                ...
                <form action="./verifying.php" method="POST" class="w-full my-2 text-center flex flex-col items-center justify-center">
                    ...
                    <div class="my-4 text-left font-semibold w-5/6 lg:w-4/6 md:w-4/6 space-y-4">
                        <div class="space-y-1">
                            ...
                            <input class="w-full rounded-xl bg-gray-800 border-2 border-blue-500 font-normal" type="text" name="shortname" id="shortname" placeholder="Enter you short name" required>
                        ...
                        <div class="space-y-1 text-center">
                            <input class="p-2 transition-all duration-100 w-full cursor-not-allowed bg-blue-500 hover:bg-blue-700 hover:shadow-lg rounded-xl font-semibold text-base" type="submit" name="createacc" id="createacc" value="Create Account" disabled>
                        </div>
                    </div>
