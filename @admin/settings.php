            ...
            <div class="w-5/6 h-max shadow-lg">
                <form action="./updatesettings.php" method="POST" class="rounded-xl p-4 bg-black/20 border-2 border-white/60 gap-4 grid">
                    ...
                    <div class="w-full grid grid-cols-12 gap-4">
                        <input class="transition-all duration-100 ease-in-out cursor-pointer rounded-xl bg-blue-500 hover:bg-blue-700 text-white px-4 py-2 font-bold" type="submit" name="save" id="save" value="Save">
                    </div>
                </form>
            </div>
        </div>
