<div id="myModal2" class="fixed inset-0 w-full flex items-center justify-center bg-black/80 opacity-0 pointer-events-none transition-opacity duration-300">
    <div id="modalBox2" class="bg-gray-800 p-6 rounded-xl shadow-lg transform scale-95 transition-all duration-100 w-2/6">
        <h2 class="text-2xl font-semibold pb-2 mb-2 border-b border-gray-500">Add New Genre</h2>
        
        <form action="./genre/genre_add.php" method="POST" class="grid grid-cols-12 gap-2 w-full space-y-1">
            <div class="w-full col-span-12 text-left space-y-1">
                ...
                <input class="w-full rounded-xl text-black" type="text" name="name" id="name" placeholder="Type genre name" required>
            </div>
            ...
            <div class="w-full col-span-12 text-left space-y-1">
                ...
                <input class="w-full rounded-xl text-black" type="text" name="banner" id="banner" placeholder="Enter genre banner URL">
            ...
            <div class="w-full col-span-12 grid grid-cols-12 gap-2">
                ...
                <a href="#" onclick="closeModal2()" class="col-span-6 h-10 cursor-pointer flex items-center justify-center bg-red-500 text-white rounded-xl font-semibold hover:bg-red-700">Close</a>
            </div>
        </form>
    </div>
</div>
