            ...
            <div class="px-4 max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex items-center">
                    <ul class="flex flex-row mt-0 space-x-2 rtl:space-x-reverse text-sm font-semibold">
                        ...
                        <li>
                            <a href="./" class="px-2 py-1 transition-all duration-100 ease-in-out flex flex-row items-center gap-2 border-b-4 border-transparent hover:border-blue-500" id="dashboard" aria-current="page">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-layout-dashboard-icon lucide-layout-dashboard"><rect width="7" height="9" x="3" y="3" rx="1"/><rect width="7" height="5" x="14" y="3" rx="1"/><rect width="7" height="9" x="14" y="12" rx="1"/><rect width="7" height="5" x="3" y="16" rx="1"/></svg>    
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="./contents.php" class="px-2 py-1 transition-all duration-100 ease-in-out flex flex-row items-center gap-2 border-b-4 border-transparent hover:border-blue-500" id="contents" aria-current="page">
                        ...
                        <li>
                            <a href="./manageusers.php" class="px-2 py-1 transition-all duration-100 ease-in-out flex flex-row items-center gap-2 border-b-4 border-transparent hover:border-blue-500" id="manageusers" aria-current="page">
                        ...
                        <li>
                            <a href="./requests.php" class="px-2 py-1 transition-all duration-100 ease-in-out flex flex-row items-center gap-2 border-b-4 border-transparent hover:border-blue-500" id="requests" aria-current="page">
                        ...
                        <li>
                            <a href="./settings.php" class="px-2 py-1 transition-all duration-100 ease-in-out flex flex-row items-center gap-2 border-b-4 border-transparent hover:border-blue-500" id="settings" aria-current="page">
