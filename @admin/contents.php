        ...
        <div class="w-full max-w-screen-xl flex flex-row gap-2 p-2">
            <div class="w-1/6 h-max rounded-xl p-2 bg-black/20 border-2 border-white/60 shadow-lg">
                <div class="text-left space-y-1 font-semibold flex flex-col">
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start bg-blue-500" id="select_btn_1">
                    ...
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start" id="select_btn_2">
                    ...
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start" id="select_btn_3">
                    ...
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start" id="select_btn_4">
                    ...
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start" id="select_btn_5">
                    ...
                    <a href="#" class="select_btn rounded-xl transition-all duration-100 ease-in-out p-2 hover:bg-blue-700 space-x-2 flex flex-row items-center justify-start" id="select_btn_6">
            ...
            <div class="w-5/6 h-max shadow-lg">
                <div class="exp_div rounded-xl p-4 bg-black/20 border-2 border-white/60" id="div_1">
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <button onclick="openModal1()" class="transition-all duration-100 ease-in-out rounded-xl border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-700 hover:border-blue-700 hover:text-white">Add New Content</button>

                        <?php include './contents/addnewcontentmodal.php'; ?>
                    </div>
                ...
                <div class="exp_div rounded-xl p-4 bg-black/20 border-2 border-white/60 hidden" id="div_2">
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <button onclick="openModal2()" class="transition-all duration-100 ease-in-out rounded-xl border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-700 hover:border-blue-700 hover:text-white">Add New Genre</button>

                        <?php include './genre/addnewgenremodal.php'; ?>
                    </div>
                    
                    <hr class="my-2 border-1">

                    <?php include './genre/genretable.php'; ?>
                </div>
                ...
                <div class="exp_div rounded-xl p-4 bg-black/20 border-2 border-white/60 hidden" id="div_3">
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <button onclick="openModal3()" class="transition-all duration-100 ease-in-out rounded-xl border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-700 hover:border-blue-700 hover:text-white">Add New Category</button>

                        <?php include './category/addnewcategorymodal.php'; ?>
                    </div>
                    
                    <hr class="my-2 border-1">

                    <?php include './category/categorytable.php'; ?>
                </div>
                ...
                <div class="exp_div rounded-xl p-4 bg-black/20 border-2 border-white/60 hidden" id="div_4">
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <button onclick="openModal4()" class="transition-all duration-100 ease-in-out rounded-xl border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-700 hover:border-blue-700 hover:text-white">Add New Quality</button>

                        <?php include './quality/addnewqualitymodal.php'; ?>
                    </div>
                    
                    <hr class="my-2 border-1">

                    <?php include './quality/qualitytable.php'; ?>
                </div>
                ...
                <div class="exp_div rounded-xl p-4 bg-black/20 border-2 border-white/60 hidden" id="div_5">
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <a href="" class="transition-all duration-100 ease-in-out rounded-xl border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-700 hover:border-blue-700 hover:text-white">Add Content</a>
                    </div>
        ...
        for(let i=1; i<=6; i++){
            ...
            if (document.getElementById("search-table"+i) && typeof simpleDatatables.DataTable !== 'undefined') {
                const dataTable = new simpleDatatables.DataTable("#search-table"+i, {
                    ...
                    columns: [
                        {
                            select: 0,        // assuming ID is column 0
