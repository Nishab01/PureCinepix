        ...
        <div class="w-full max-w-screen-xl flex flex-row gap-2 p-2">
            <div class="w-1/6 h-max rounded-lg p-2 bg-black/20 border-2 border-white/60 shadow-lg">
                <div class="text-left space-y-1 font-semibold flex flex-col">
                    ...
                    <a href="#" class="select_btn rounded-lg transition-all duration-100 ease-in-out p-2 hover:bg-blue-500 space-x-2 flex flex-row items-center justify-start" id="select_btn_6">
            ...
            <div class="w-5/6 h-max shadow-lg">
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60" id="div_1">
                ...
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60 hidden" id="div_2">
                    <div class="flex flex-row justify-between items-center">
                ...
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60 hidden" id="div_3">
                    <div class="flex flex-row justify-between items-center">
                ...
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60 hidden" id="div_4">
                    <div class="flex flex-row justify-between items-center">
                ...
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60 hidden" id="div_5">
                    <div class="flex flex-row justify-between items-center">
                        <p class="text-2xl font-semibold">Trending</p>
                        <a href="" class="transition-all duration-100 ease-in-out rounded-lg border-2 border-blue-500 text-blue-500 font-semibold p-2 hover:bg-blue-500 hover:text-white">Add Content</a>
                    </div>
                ...
                <div class="exp_div rounded-lg p-4 bg-black/20 border-2 border-white/60 hidden" id="div_6">
                    <div class="flex flex-row justify-between items-center">
