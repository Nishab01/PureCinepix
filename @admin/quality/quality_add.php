...
<body>
    <?php
        ...
        $insertquality = "INSERT INTO types
            (`name`, `section`, `slug`, `banner`, `status`, `created_at`) VALUES
            ('".$name."', '".$section."', '".$slug."', '".$banner."', '".$status."', '".$created_at."');
        ";

        $result = mysqli_query($conn, $insertquality);
        if (!$result) {
